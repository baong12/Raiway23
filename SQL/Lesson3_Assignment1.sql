...
VALUES  ('Nguyễn Thành Long',   '1996-12-03', 'male',   12, 8,  30, 'Railway 1', 'Excellent', 'long_nguyen96'),
        ...
        ('Huỳnh Quang Ngọc',    '1996-12-11', 'male',   20, 10,  49, 'Spaceship 5', 'Trời ơi xuất sắc', 'ngoc_huynh96'),
        ...
        ('Phí Hương Giang',     '2000-03-26', 'female', 18, 6,  22, 'Mothership 8', 'Extra terrestrial', 'giang_phi2k'),
...
SELECT *, LENGTH(full_name) as 'Độ dài của tên'
FROM trainee
