...
public class Employee extends Account implements Serializable {
	...
	public Employee(@NonNull String email, String username, String firstName, String lastName, Department department,
			Position position, Salary salary, Date createDate, @NonNull Short workingNumberOfYear) {
